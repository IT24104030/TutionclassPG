    ...
    try {
        ...
        <div class="section-header">
            ...
            <div class="d-flex gap-2">
                ...
                <button class="btn btn-primary-custom" onclick="showAddStudent()">
...
function showAddStudent() {
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6"><label class="form-label">Phone *</label><input type="text" class="form-control" id="sPhone"></div>
        ...
        <div class="col-md-6"><label class="form-label">Parent Phone</label><input type="text" class="form-control" id="sParentPhone"></div>
...
async function saveNewStudent() {
    ...
    if (!phoneRegex.test(payload.phone)) return toast('Enter valid phone number', 'warning');
    if (payload.email && !emailRegex.test(payload.email)) return toast('Enter valid email', 'warning');
    if (payload.parentPhone && !phoneRegex.test(payload.parentPhone)) return toast('Enter valid parent phone', 'warning');
...
async function editStudent(id) {
    try {
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6"><label class="form-label">Phone *</label><input class="form-control" id="esPhone" value="${s.phone}"></div>
            ...
            <div class="col-md-6"><label class="form-label">Parent Phone</label><input class="form-control" id="esParentPhone" value="${s.parentPhone||''}"></div>
        </div>`;
...
async function showAddResult() {
    ...
    <div class="row g-3">
        ...
        <div class="col-md-4"><label class="form-label">Marks Obtained *</label><input class="form-control" id="rMarks" type="number"></div>
        <div class="col-md-4"><label class="form-label">Total Marks *</label><input class="form-control" id="rTotal" type="number" value="100"></div>
        <div class="col-md-4"><label class="form-label">Exam Date</label><input class="form-control" id="rDate" type="date"></div>
    ...
    openModal('<i class="fas fa-plus me-2"></i>Add Result', form, async () => {
        const payload = {
            ...
            marksObtained: parseFloat(document.getElementById('rMarks').value),
            totalMarks:    parseFloat(document.getElementById('rTotal').value),
            examDate:      document.getElementById('rDate').value||null,
...
async function editResult(id) {
    ...
    <div class="row g-3">
        ...
        <div class="col-md-3"><label class="form-label">Marks Obtained</label><input class="form-control" id="erMarks" type="number" value="${r.marksObtained}"></div>
        <div class="col-md-3"><label class="form-label">Total Marks</label><input class="form-control" id="erTotal" type="number" value="${r.totalMarks}"></div>
    ...
    openModal('<i class="fas fa-edit me-2"></i>Edit Result', form, async () => {
        const payload = {
            ...
            marksObtained: parseFloat(document.getElementById('erMarks').value),
            totalMarks: parseFloat(document.getElementById('erTotal').value),
